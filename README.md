<h1 align="center">Hi there, I’m Abhijeet Shinde 👋</h1>
<h3 align="center">Software Developer | Backend Enthusiast | Computer Engineering Student @ VIIT Pune</h3>
...
![RapidAPI](https://img.shields.io/badge/RapidAPI-%2300ADF0.svg?style=flat&logo=rapidapi&logoColor=white)
...
#### 🔷 EduViva
An AI-powered virtual interview and assessment platform using React, Django, MongoDB, and Google Speech-to-Text NLP.

#### 🔶 Sansthaein Aur Samvidhan
A gamified web app promoting constitutional literacy using React and Node.js.

#### 🔐 Authentication System
A robust login/signup system using JWT with React, Django, and MongoDB.

#### 📈 English Proficiency Analyzer
NLP-based model to evaluate and improve English communication skills using ML prediction on learning paths.
